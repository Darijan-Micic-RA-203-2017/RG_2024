...
// light source inside refrigerator rendering header. This prevents linking conflicts.
#ifndef LIGHT_SOURCE_INSIDE_REFRIGERATOR_RENDERING_H
#define LIGHT_SOURCE_INSIDE_REFRIGERATOR_RENDERING_H
