...
int main()
{
	...
	float verticesOfRefrigerator[] = {
		// position                // normal vector     // color
		  ...
		  -0.9F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F,  0.0F, 0.5F, 
		   0.9F,    0.9F,    1.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F,  0.0F, 0.5F, 
		   0.9F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F,  0.0F, 0.5F, 
		  -0.9F,   -0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.0F,  0.9F,  0.0F, 0.5F, // refrigerator (left side)
		  -0.8F,   -0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.0F,  0.9F,  0.0F, 0.5F, // - back side
		  -0.9F,    0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,    0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,   -0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F, 0.5F, // refrigerator (left side)
		  -0.8F,   -0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F, 0.5F, // - front side
		  -0.9F,    0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,    0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,   -0.9F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // refrigerator (left side)
		  -0.9F,   -0.9F,    0.9F, -1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // - left side
		  -0.9F,    0.9F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,    0.9F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,   -0.9F,    0.9F, -1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,    0.9F,    0.9F, -1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,    0.9F,  1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // refrigerator (left side)
		  -0.8F,   -0.9F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // - right side
		  -0.8F,    0.9F,    0.9F,  1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,    0.9F,  1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,   -0.9F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // refrigerator (left side)
		  -0.8F,   -0.9F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // - bottom side
		  -0.9F,   -0.9F,    0.9F,  0.0F, -1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,   -0.9F,    0.9F,  0.0F, -1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,    0.9F,  0.0F, -1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // refrigerator (left side)
		  -0.8F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, // - top side
		  -0.9F,    0.9F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.9F,    0.9F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.0F, 0.5F, 
		  /*
		   ...
		   0.8F,    0.8F,   -1.0F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.9F, 0.5F, 
		   */
		  -0.8F,   -0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (bottom side)
		   0.8F,   -0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - back side
		  -0.8F,   -0.8F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.8F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.8F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (bottom side)
		   0.8F,   -0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - front side
		  -0.8F,   -0.8F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.8F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.8F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (bottom side)
		  -0.8F,   -0.9F,    0.9F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - left side
		  -0.8F,   -0.8F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.8F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,    0.9F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.8F,    0.9F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.9F,    0.9F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (bottom side)
		   0.8F,   -0.9F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - right side
		   0.8F,   -0.8F,    0.9F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.8F,    0.9F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.9F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.8F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (bottom side)
		   0.8F,   -0.9F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - bottom side
		  -0.8F,   -0.9F,    0.9F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.9F,    0.9F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.9F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.9F,    0.9F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.8F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (bottom side)
		   0.8F,   -0.8F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - top side
		  -0.8F,   -0.8F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,   -0.8F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.8F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,   -0.8F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.8F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (top side)
		   0.8F,    0.8F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - back side
		  -0.8F,    0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.8F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.9F,   -1.1F,  0.0F,  0.0F, -1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.8F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (top side)
		   0.8F,    0.8F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - front side
		  -0.8F,    0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.8F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.9F,    0.9F,  0.0F,  0.0F,  1.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.8F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (top side)
		  -0.8F,    0.8F,    0.9F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - left side
		  -0.8F,    0.9F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,   -1.1F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.8F,    0.9F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,    0.9F, -1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.8F,    0.9F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (top side)
		   0.8F,    0.8F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - right side
		   0.8F,    0.9F,    0.9F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.9F,    0.9F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.8F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.9F,   -1.1F,  1.0F,  0.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.8F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (top side)
		   0.8F,    0.8F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - bottom side
		  -0.8F,    0.8F,    0.9F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.8F,    0.9F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.8F,   -1.1F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.8F,    0.9F,  0.0F, -1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // refrigerator (top side)
		   0.8F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, // - top side
		  -0.8F,    0.9F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		  -0.8F,    0.9F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.9F,    0.9F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
		   0.8F,    0.9F,   -1.1F,  0.0F,  1.0F,  0.0F,  0.9F,  0.9F,  0.0F, 0.5F, 
	...
	while (glfwWindowShouldClose(window) == GLFW_FALSE)
	{
		...
		else
		{
			...
			// glDrawArrays(GL_TRIANGLES, 180, 6); // refrigerator (rest of it)

			// Always turn on the blending when rendering the graphical elements and text, due to the way the "FreeType"
			// library is implemented.
			glEnable(GL_BLEND);

			// glDrawArrays(GL_TRIANGLES, 186, 36);  // digital clock rectangle widget
			glDrawArrays(GL_TRIANGLES, 180, 36);  // digital clock rectangle widget
			// glDrawArrays(GL_TRIANGLES, 222, 36); // see-through mode activation button
			glDrawArrays(GL_TRIANGLES, 216, 36);  // see-through mode activation button
			// glDrawArrays(GL_TRIANGLES, 258, 6);  // rectangle symbol on the see-through mode activation button
			glDrawArrays(GL_TRIANGLES, 252, 6);  // rectangle symbol on the see-through mode activation button
			// glDrawArrays(GL_TRIANGLES, 264, 36); // "-" button, left of freezing chamber temperature widget
			glDrawArrays(GL_TRIANGLES, 258, 36); // "-" button, left of freezing chamber temperature widget
			// glDrawArrays(GL_LINES, 300, 2);      // line representing the "-" sign itself
			glDrawArrays(GL_LINES, 294, 2);      // line representing the "-" sign itself
			// glDrawArrays(GL_TRIANGLES, 302, 36); // freezing chamber temperature widget
			glDrawArrays(GL_TRIANGLES, 296, 36); // freezing chamber temperature widget
			// glDrawArrays(GL_TRIANGLES, 338, 36); // "+" button, left of freezing chamber temperature widget
			glDrawArrays(GL_TRIANGLES, 332, 36); // "+" button, left of freezing chamber temperature widget
			// glDrawArrays(GL_LINES, 374, 4);      // line representing the "+" sign itself
			glDrawArrays(GL_LINES, 368, 4);      // line representing the "+" sign itself
			// glDrawArrays(GL_TRIANGLES, 378, 36); // "-" button, left of refrigerating chamber temperature widget
			...
			// glDrawArrays(GL_TRIANGLES, 416, 36); // refrigerating chamber temperature widget
			glDrawArrays(GL_TRIANGLES, 410, 36); // refrigerating chamber temperature widget
			// glDrawArrays(GL_TRIANGLES, 452, 36); // "+" button, left of refrigerating chamber temperature widget
			glDrawArrays(GL_TRIANGLES, 446, 36); // "+" button, left of refrigerating chamber temperature widget
			// glDrawArrays(GL_LINES, 488, 4);      // line representing the "+" sign itself
